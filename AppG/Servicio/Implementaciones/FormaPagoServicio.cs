...
namespace AppG.Servicio
{
    public class FormaPagoServicio : BaseServicio<FormaPago>, IFormaPagoServicio
    {
        ...
        public void ExportarDatosExcelAsync(Excel<FormaPagoDto> res)
        {
            ...
            var filePath = Path.Combine(directorioPath, "formas-pago.xlsx");
            ...
            using (var package = new ExcelPackage())
            {
                ...
                if (File.Exists(filePath))
                {
                    ...
                    worksheet = package.Workbook.Worksheets["Forma de pago"];

                    if (worksheet == null)
                    {
                        worksheet = package.Workbook.Worksheets.Add("Forma de pago");
                    }
                }
                else
                {
                ...
                worksheet.Cells["A1"].Value = "Forma de pago";
