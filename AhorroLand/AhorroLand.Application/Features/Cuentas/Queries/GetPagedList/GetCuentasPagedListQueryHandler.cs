    ...
    : GetPagedListQueryHandler<Cuenta, CuentaDto, GetCuentasPagedListQuery>
{
    ...
    /// </summary>
    protected override IQueryable<Cuenta> ApplyQuery(GetCuentasPagedListQuery query)
    {
        IQueryable<Cuenta> queryable = GetQueryBase();
        ...
        if (!string.IsNullOrWhiteSpace(query.SortColumn))
        {
            ...
            Expression<Func<Cuenta, object>> keySelector = query.SortColumn.ToLower() switch
            {
